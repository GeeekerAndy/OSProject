...
public class Condition2 {
	...
	public void sleep() {
		...
		// Add the current thread to waitQueue and sleep it.
	...
	public void wake() {
		...
		// Wake at most one thread in waitQueue
	...
	public static void selfTest() {
		...
		thread = new KThread(new Runnable() {
			// Nobody holds the condition lock
		...
		// Verify that thread reacquire lock when woken.
